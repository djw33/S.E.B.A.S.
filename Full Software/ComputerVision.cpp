...
float ComputerVision::update(int Hue1, int Saturation1, int Value1, int Hue2, int Saturation2, int Value2, float * positionOut, float * velocityOut, float * headingOut) {
	Mat imgOriginal;
	Mat imgHSV;
